    ...
    <>
      ...
      <SimpleGrid name="skills" mt={'7%'} gap='5%' columns={[1, 1, 2]}>
        <Box className={styles.front}>
          <Text fontSize={'xx-large'} fontWeight='semibold' color={'#f4e16a'} textAlign='center'  >FRONTEND SKILLS</Text>
        ...
        <Box className={styles.back}>
          <Text fontSize={'xx-large'} fontWeight='semibold' color={'#f4e16a'} textAlign='center'  >BACKEND SKILLS</Text>
          <SimpleGrid rowGap='20px' m='20px' gap={'-50px'} columns={[2, 2, 2, 3]}>
            {
              back.map((f) => {
                return (
      ...
      <Box mb={'7%'} mt={['70px','70px','50px','50px']} className={styles.front}>
        <Text fontSize={'xx-large'} fontWeight='semibold' color={'#f4e16a'} textAlign='center'>TOOLS</Text>
